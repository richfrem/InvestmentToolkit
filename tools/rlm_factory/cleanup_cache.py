...
Usage Examples:
    python tools/rlm-factory/cleanup_cache.py --help
    python tools/rlm-factory/cleanup_cache.py --apply --prune-orphans
...
def main():
    ...
    if args.apply:
        ...
        if args.prune_orphans:
            print(f"  python tools/rlm-factory/cleanup_cache.py --apply --prune-orphans")
        else:
            print(f"  python tools/rlm-factory/cleanup_cache.py --apply")
