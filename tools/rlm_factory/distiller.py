...
Usage Examples:
    ...
    python tools/rlm-factory/distiller.py --file docs/architecture/overview.md
    python tools/rlm-factory/distiller.py --since 24

    # 2. Force update
    python tools/rlm-factory/distiller.py --target docs/ --force
