...
Usage Examples:
    ...
    python tools/tool-inventory/distiller.py --file tools/tool-inventory/rlm_config.py
    python tools/tool-inventory/distiller.py --file tools/tool-inventory/distiller.py --force
