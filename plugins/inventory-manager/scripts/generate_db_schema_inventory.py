...
# Configuration: Granular Directories
REPO_ROOT = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
DB_ROOT = os.path.join(REPO_ROOT, 'legacy-system', 'oracle-database')
...
INVENTORIES_DIR = os.path.join(REPO_ROOT, 'legacy-system', 'reference-data', 'inventories')
