...
|----------|----------|---------|-----------|
| `~~portfolio-api` | `GET /api/theses/:id/health`, Portfolio DB | `portfolio_health` SKILL | Supercharged |
| `~~thesis-store` | `GET /api/theses`, JSON thesis files | `portfolio_health` SKILL | Supercharged |
