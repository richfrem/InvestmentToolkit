...
Usage:
    ...
    # As a CLI
    python3 tools/tool_inventory/inventory.py
    python3 tools/tool_inventory/tool_chroma.py stats
    python3 tools/tool_inventory/tool_chroma.py search "query cache"
    python3 tools/tool_inventory/tool_chroma.py list
    python3 tools/tool_inventory/tool_chroma.py import-json .agent/learning/rlm_tool_cache.json
"""
