...
Usage Examples:
    ...
    python tools/tool_inventory/distiller.py --file tools/tool_inventory/rlm_config.py
    python tools/tool_inventory/distiller.py --file tools/tool_inventory/distiller.py --force
...
Script Dependencies:
    ...
    - tools/tool-inventory/manage_tool_inventory.py (Cyclical: Updates inventory descriptions)
    - plugins/tool-inventory/scripts/cleanup_cache.py (Orphan Removal)

Consumed by:
    - tools/tool-inventory/manage_tool_inventory.py (Invokes distiller on tool updates)
"""
