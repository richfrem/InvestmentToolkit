...
try:
    from rlm_config import RLMConfig, load_cache, PROJECT_ROOT
except ImportError:
    from tools.tool_inventory.rlm_config import RLMConfig, load_cache, PROJECT_ROOT
...
def main():
    ...
    if not entry:
        ...
        print("   Run 'python plugins/rlm-factory/scripts/query_cache.py --type tool \"term\"' to search.")
        sys.exit(1)
