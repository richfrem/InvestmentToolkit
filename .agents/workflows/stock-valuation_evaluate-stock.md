...
8.  **Generate Research Report** — rich narrative markdown (Skill Step 7):
    ...
    ```
    Write to `investment_screener/backend/data/research/{TICKER}_{YYYY-MM-DD}.md`.
...
| Fetch Script | `investment_screener/backend/py_services/fetch_financials.py` |
| Persist Script | `investment_screener/backend/py_services/persist_projection.py` |
| Projections Dir | `investment_screener/backend/data/projections/` |
| Research Dir | `investment_screener/backend/data/research/` |
