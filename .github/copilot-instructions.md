...
| `/pine-analyze {TICKER}` | **tradingview** | *(Phase 2 — planned)* Generate custom Pine Script v5 TA, inject via CDP, read indicator values, synthesize into Initiate/Accumulate/Trim/Exit advisory. |
