...
class TestHarvestEarningsExpectationsDedup:
    ...
    def test_harvest_appends_on_no_prior_record(self):
    ...
    def test_harvest_tail_limit_1000(self):
    ...
    def test_harvest_gracefully_degrades_on_missing_file(self):
    ...
    def test_harvest_uses_target_portfolio_when_no_tickers(self):
