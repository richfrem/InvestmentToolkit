...
Purpose:
    ...
    data (docs/superpowers/audits/json-discovery-audit.json) into a per-
...
Key Input Dependencies:
    - docs/superpowers/audits/json-discovery-audit.json (produced by audit_json_usage.py)
...
Usage:
    python3 build_consumer_inventory.py \
        --audit docs/superpowers/audits/json-discovery-audit.json \
...
def render_inventory_md(inventory: list) -> str:
    ...
    lines = [
        ...
        "Machine-generated by inverting docs/superpowers/audits/json-discovery-audit.json's "
...
def main():
    ...
    parser.add_argument("--audit", default="docs/superpowers/audits/json-discovery-audit.json")
