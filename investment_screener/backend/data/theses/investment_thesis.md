...
*Portfolio value: $30,731. Refresh: `python3 plugins/portfolio-advisor/scripts/generate_portfolio_blueprint.py --write`*

### Sub-Strategy 1 — SA / ASI Race (Aschenbrenner Framework)

| Ticker | Thesis Action | AI Signal | Actual % | Target % | Upside | Conviction |
| :--- | :--- | :--- | ---: | ---: | ---: | :--- |
| **CRWV** | 🟡 TRIM | — | 7.05% | 3.84% | — | GPU cloud provider. |
| **SNDK** | 🟡 TRIM | — | 5.70% | 3.34% | — | NAND storage infrastructure play. |
| **GOOG** | ⚪ MAINTAIN | — | 4.59% | 4.06% | — | Hyperscaler with vertically integrated AI stack. |
| **DRAM** | ⚪ MAINTAIN | — | 4.29% | 4.57% | — | Only US-listed vehicle for SK Hynix (25.9%) and Samsung (21.6%) HBM exposure — Nvidia's #1 and #2 HBM suppliers, not tradeable directly on US exchanges. Strategic memory play: HBM is the critical scarcity resource in AI compute scaling. Korean/Japanese memory consolidation thesis. Wait for pullback from current levels (+94.6% in 6mo) before initiating. |
| **NBIS** | 🟡 TRIM | — | 4.14% | 3.06% | — | European AI infrastructure. |
| **IREN** | ⚪ MAINTAIN | — | 4.07% | 3.71% | — | AI GPU cloud pivot — 800MW Australia campus + Blackwell GPU deployment. Increased target weight to 3.638% (31 shares) to accumulate on dilution dip in RRSP (+3) and TFSA (+6) as execution play. |
| **BE** | 🟡 TRIM | — | 3.86% | 2.12% | — | Bloom Energy fuel cells. |
| **CORZ** | ⚪ MAINTAIN | — | 3.46% | 3.81% | — | BTC→AI data center conversion thesis. |
| **CBRS** | 🟡 TRIM | — | 2.93% | 2.54% | — | Monolithic Wafer-Scale AI compute engine delivering 21 PB/s memory bandwidth for ultra-high-speed reasoning and real-time agentic inference. |
| **CEG** | ⚪ MAINTAIN | — | 2.70% | 2.54% | — | Largest US nuclear operator. |
| **TEAM** | 🟡 TRIM | — | 2.33% | 1.93% | — | Human-agentic collaboration platform. |
| **APLD** | ⚪ MAINTAIN | — | 2.22% | 2.54% | — | Situational Awareness LP core holding. AI data center infrastructure play aligned with SA fund thesis on ASI race build-out. |
| **VST** | ⚪ MAINTAIN | — | 2.06% | 1.93% | — | Nuclear + natgas power merchant. |
| **BTDR** | ⚪ MAINTAIN | — | 1.95% | 1.95% | — | Proprietary Sealminer ASIC chip design. |
| **PSIX** | 🔵 ACCUMULATE | — | 1.62% | 2.03% | — | AI power infrastructure. |
| **OKLO** | ⚪ MAINTAIN | — | 1.57% | 1.52% | — | Micro-nuclear reactor commercialization. Power pillar speculative play — same theme as BE and CEG. AI data center power demand requires diverse nuclear supply; OKLO's micro-reactor model targets co-location with data centers. |
...
| **Subtotal** | | **54.52%** | **45.49%** | -9.04pp | |

### Sub-Strategy 2 — AI-Native Cybersecurity

| Ticker | Thesis Action | AI Signal | Actual % | Target % | Upside | Conviction |
| :--- | :--- | :--- | ---: | ---: | ---: | :--- |
| **ZS** | 🟡 TRIM | — | 5.46% | 4.57% | — | Zero-trust SASE leader. |
| **PANW** | 🔵 ACCUMULATE | — | 3.72% | 4.57% | — | AI-native platform consolidation leader. |
| **CRWD** | 👁️ WATCHLIST | — | — | — | — | EXIT: DCF -66% downside. |
| **Subtotal** | | **9.18%** | **9.14%** | -0.04pp | |

### Sub-Strategy 3 — Sovereign Finance

| Ticker | Thesis Action | AI Signal | Actual % | Target % | Upside | Conviction |
| :--- | :--- | :--- | ---: | ---: | ---: | :--- |
| **COIN** | ⚪ MAINTAIN | — | 3.39% | 3.05% | — | Regulated crypto exchange + Base L2 growth. Settlement rail for AI Agents. |
| **CRCL** | ⚪ MAINTAIN | — | 2.85% | 2.79% | — | USDC issuer and stablecoin infrastructure for AI agents. |
...
| **Subtotal** | | **6.25%** | **5.84%** | -0.41pp | |

### Sub-Strategy 4 — Quality SaaS Resilience

| Ticker | Thesis Action | AI Signal | Actual % | Target % | Upside | Conviction |
| :--- | :--- | :--- | ---: | ---: | ---: | :--- |
| **CRM** | ⚪ MAINTAIN | — | 2.12% | 1.93% | — | Agentforce AI platform. |
| **NOW** | ⚪ MAINTAIN | — | 2.08% | 1.93% | — | AI workflow automation. |
| **Subtotal** | | **4.20%** | **3.86%** | -0.35pp | |
...
| | Actual % | Target % | Delta |
| :--- | ---: | ---: | ---: |
| **All holdings** | **86.54%** | **83.11%** | -3.43pp |
