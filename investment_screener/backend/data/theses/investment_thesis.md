...
*Generated 2026-07-12 · Source: `validate_weights.py` × `target-portfolio.json` × `portfolio.json` (Questrade live)*
*Portfolio value: $30,355. Refresh: `python3 plugins/portfolio-advisor/scripts/generate_portfolio_blueprint.py --write`*

### Sub-Strategy 1 — SA / ASI Race (Aschenbrenner Framework)

| Ticker | Thesis Action | AI Signal | Actual % | Target % | Upside | Conviction |
| :--- | :--- | :--- | ---: | ---: | ---: | :--- |
| **CRWV** | 🟡 TRIM | — | 7.03% | 3.77% | — | GPU cloud provider. |
| **SNDK** | 🟡 TRIM | — | 5.93% | 3.28% | — | NAND storage infrastructure play. |
| **GOOG** | 🟡 TRIM | — | 4.68% | 3.98% | — | Hyperscaler with vertically integrated AI stack. |
| **DRAM** | ⚪ MAINTAIN | — | 4.36% | 4.48% | — | Only US-listed vehicle for SK Hynix (25.9%) and Samsung (21.6%) HBM exposure — Nvidia's #1 and #2 HBM suppliers, not tradeable directly on US exchanges. Strategic memory play: HBM is the critical scarcity resource in AI compute scaling. Korean/Japanese memory consolidation thesis. Wait for pullback from current levels (+94.6% in 6mo) before initiating. |
| **NBIS** | 🟡 TRIM | — | 4.34% | 3.00% | — | European AI infrastructure. |
| **IREN** | 🟡 TRIM | — | 4.20% | 3.64% | — | AI GPU cloud pivot — 800MW Australia campus + Blackwell GPU deployment. Increased target weight to 3.638% (31 shares) to accumulate on dilution dip in RRSP (+3) and TFSA (+6) as execution play. |
| **BE** | 🟡 TRIM | — | 4.03% | 2.08% | — | Bloom Energy fuel cells. |
| **CORZ** | ⚪ MAINTAIN | — | 3.56% | 3.73% | — | BTC→AI data center conversion thesis. |
| **CBRS** | 🟡 TRIM | — | 3.19% | 2.49% | — | Monolithic Wafer-Scale AI compute engine delivering 21 PB/s memory bandwidth for ultra-high-speed reasoning and real-time agentic inference. |
| **CEG** | ⚪ MAINTAIN | — | 2.73% | 2.49% | — | Largest US nuclear operator. |
| **TEAM** | 🟡 TRIM | — | 2.34% | 1.89% | — | Human-agentic collaboration platform. |
| **APLD** | ⚪ MAINTAIN | — | 2.26% | 2.49% | — | Situational Awareness LP core holding. AI data center infrastructure play aligned with SA fund thesis on ASI race build-out. |
| **VST** | ⚪ MAINTAIN | — | 2.09% | 1.89% | — | Nuclear + natgas power merchant. |
| **BTDR** | ⚪ MAINTAIN | — | 1.97% | 1.91% | — | Proprietary Sealminer ASIC chip design. |
| **OKLO** | ⚪ MAINTAIN | — | 1.61% | 1.49% | — | Micro-nuclear reactor commercialization. Power pillar speculative play — same theme as BE and CEG. AI data center power demand requires diverse nuclear supply; OKLO's micro-reactor model targets co-location with data centers. |
| **PSIX** | 🔵 ACCUMULATE | — | 1.59% | 1.99% | — | AI power infrastructure. |
...
| **Subtotal** | | **55.92%** | **46.56%** | -9.36pp | |

### Sub-Strategy 2 — AI-Native Cybersecurity

| Ticker | Thesis Action | AI Signal | Actual % | Target % | Upside | Conviction |
| :--- | :--- | :--- | ---: | ---: | ---: | :--- |
| **ZS** | 🟡 TRIM | — | 5.51% | 4.48% | — | Zero-trust SASE leader. |
| **PANW** | 🔵 ACCUMULATE | — | 3.76% | 4.48% | — | AI-native platform consolidation leader. |
| **CRWD** | 👁️ WATCHLIST | — | — | — | — | EXIT: DCF -66% downside. |
| **Subtotal** | | **9.26%** | **8.96%** | -0.31pp | |

### Sub-Strategy 3 — Sovereign Finance

| Ticker | Thesis Action | AI Signal | Actual % | Target % | Upside | Conviction |
| :--- | :--- | :--- | ---: | ---: | ---: | :--- |
| **COIN** | ⚪ MAINTAIN | — | 3.41% | 2.99% | — | Regulated crypto exchange + Base L2 growth. Settlement rail for AI Agents. |
| **CRCL** | ⚪ MAINTAIN | — | 2.83% | 2.74% | — | USDC issuer and stablecoin infrastructure for AI agents. |
...
| **Subtotal** | | **6.24%** | **5.72%** | -0.52pp | |

### Sub-Strategy 4 — Quality SaaS Resilience

| Ticker | Thesis Action | AI Signal | Actual % | Target % | Upside | Conviction |
| :--- | :--- | :--- | ---: | ---: | ---: | :--- |
| **CRM** | ⚪ MAINTAIN | — | 2.15% | 1.89% | — | Agentforce AI platform. |
| **NOW** | ⚪ MAINTAIN | — | 2.13% | 1.89% | — | AI workflow automation. |
| **Subtotal** | | **4.28%** | **3.78%** | -0.50pp | |
...
| | Actual % | Target % | Delta |
| :--- | ---: | ---: | ---: |
| **All holdings** | **88.24%** | **83.44%** | -4.80pp |
