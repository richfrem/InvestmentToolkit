...
| Level | Document | Role |
|:---|:---|:---|
| **L1 (Law)** | [Migration Matrix](/docs/architecture/transitory/Oracle_Forms_Migration_Matrix.md) — **detailed mapping tables** | What maps to what (authoritative per ADR-0035) |
| **L2 (Pattern)** | [Trigger Pipeline](/docs/architecture/transitory/patterns/trigger_execution_pipeline.md), [Record Group Strategy](/docs/architecture/transitory/patterns/record_group_strategy.md), [Element Mapper IR](/docs/architecture/transitory/element-mapper-design.md) | How to implement specific element types |
| **L3 (Policy)** | [Transitional Architecture](/docs/architecture/transitory/transitional_architecture_details.md), `.agent/rules/03_TECHNICAL/legacy_sql_and_plsql_policy.md` | Constraints (Zero-Change DB, Strict Mirroring, Pass-through Auth) |
| **L4 (Reference)** | [Design Reviews](/docs/architecture/transitory/reviews/), [Refined IR Models](/docs/architecture/transitory/reviews/refined_ir_models.md) | Decision rationale and history |
...
*   **Read**: `docs/architecture/transitory/Oracle_Forms_Migration_Matrix.md`
*   **Use**: The **detailed mapping tables** at the top of the document (not just the 43-processor summary).
*   **For Triggers specifically**: Also read [Trigger Execution Pipeline](/docs/architecture/transitory/patterns/trigger_execution_pipeline.md) — covers event lifecycle ordering, `RAISE FORM_TRIGGER_FAILURE` handling, `ExecuteHierarchy`, and Forms built-in mapping.
*   **For RecordGroups specifically**: Also read [Record Group Strategy](/docs/architecture/transitory/patterns/record_group_strategy.md) — covers Type A/B/C/D classification and hidden WHERE clause analysis.
...
*   **Read**: `docs/architecture/transitory/transitional_architecture_details.md`
*   **Read**: `.agent/rules/03_TECHNICAL/legacy_sql_and_plsql_policy.md`
*   **Check**:
...
*   **Read**: `docs/architecture/transitory/element-mapper-design.md`
*   **Follow**:
...
1.  **Read Context**: `python tools/cli.py bundle --target [ID]`
