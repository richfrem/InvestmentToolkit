...
## Phase 1: Analysis
- [ ] **Run Investigation**: `python tools/cli.py context --target [ConstraintName] --type constraint`
- [ ] **Verify Context**: Check `temp/context-bundles/[ConstraintName]_context.md`.

## Phase 2: Documentation
- [ ] **Initialize**: Copy `.agent/templates/outputs/db-constraint-template.md` to target path.
