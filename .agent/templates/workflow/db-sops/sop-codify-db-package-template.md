...
## Phase 1: Analysis
- [ ] **Run Investigation**: `python tools/cli.py context --target [PackageName] --type package`
- [ ] **Verify Context**: Check `temp/context-bundles/[PackageName]_context.md` for procedures and functions.

## Phase 2: Documentation
- [ ] **Initialize**: Copy `.agent/templates/outputs/db-package-template.md` to target path.
