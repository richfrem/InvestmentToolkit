...
## Phase 1: Analysis
- [ ] **Run Investigation**: `python tools/cli.py context --target [ProcedureName] --type procedure`
...
- [ ] **Search Existing**: `python tools/cli.py rules search "[Keyword]"`
- [ ] **Register New**: `python tools/cli.py rules register --source [ProcedureName] --description "..."`

## Phase 2: Documentation
- [ ] **Initialize**: Copy `.agent/templates/outputs/db-procedure-template.md` to target path.
