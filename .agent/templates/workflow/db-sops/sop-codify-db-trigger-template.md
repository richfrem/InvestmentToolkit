...
## Phase 1: Analysis
- [ ] **Run Investigation**: `python tools/cli.py context --target [TriggerName] --type trigger`
- [ ] **Verify Context**: Check `temp/context-bundles/[TriggerName]_context.md` for logic.

## Phase 2: Documentation
- [ ] **Initialize**: Copy `.agent/templates/outputs/db-trigger-template.md` to target path.
