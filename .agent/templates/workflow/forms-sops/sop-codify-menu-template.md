...
## Phase 1: Analysis
- [ ] **Run Investigation**: `python tools/cli.py context --target [MenuName] --type menu`
- [ ] **Verify Context**: Check `temp/context-bundles/[MenuName]_context.md` for hierarchy and roles.

## Phase 2: Documentation
- [ ] **Initialize**: Copy `.agent/templates/outputs/menu-overview-template.md` (if exists) or base structure to target path.
