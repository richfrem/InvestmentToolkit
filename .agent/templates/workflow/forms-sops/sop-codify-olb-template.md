...
## Phase 1: Analysis
- [ ] **Run Investigation**: `python tools/cli.py context --target [LibraryName] --type olb`
- [ ] **Verify Context**: Check `temp/context-bundles/[LibraryName]_context.md`.

## Phase 2: Documentation
- [ ] **Initialize**: Copy `.agent/templates/outputs/olb-overview-template.md` (if exists) or structure to target path.
