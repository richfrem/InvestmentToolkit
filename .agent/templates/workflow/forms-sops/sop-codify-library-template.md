...
## Phase 1: Analysis
- [ ] **Run Investigation**: `python tools/cli.py context --target [LibraryName] --type lib`
- [ ] **Verify Context**: Check `temp/context-bundles/[LibraryName]_context.md` for `pll_miner` output.

## Phase 2: Documentation
- [ ] **Initialize**: Copy `.agent/templates/outputs/library-overview-template.md` (or general application template if none specific) to target path.
