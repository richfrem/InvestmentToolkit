...
## Phase 1: Analysis
- [ ] **Run Investigation**: `python tools/cli.py context --target [BR_ID] --type rule` (if ID exists) or search by keyword.
- [ ] **Verify Context**: Check `temp/context-bundles/...` or search results.

## Phase 2: Documentation
- [ ] **Initialize**: Copy `.agent/templates/outputs/business-rule-template.md` to target path.
