...
## Phase 1: Analysis
- [ ] **Run Investigation**: `python tools/cli.py context --target [BW_ID] --type workflow` (if ID exists) or search.
- [ ] **Verify Context**: Check search results.

## Phase 2: Documentation
- [ ] **Initialize**: Copy `.agent/templates/outputs/business-rule-template.md` (Use BW section) to target path.
